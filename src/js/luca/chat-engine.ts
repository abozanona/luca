...
export class ChatEngine {
    ...
    showReactionOnScreen(reactionName: string) {
        ...
        interval = setInterval(function () {
            ...
            let bounds: number = _this.getRandomInteger(LucaEngine.fullScreenElement.clientWidth * startScreenPercentage, LucaEngine.fullScreenElement.clientWidth * endScreenPercentage);
